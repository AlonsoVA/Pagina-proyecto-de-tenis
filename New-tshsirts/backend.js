function addToFavorites() {
    ...
    <section class="cardshirt">
        ...
        <div class="product-infoshirt1">
            ...
            <section class="cardshirt2" id="contentToDeletee">
                ...
                <div class="product-infoshirt2">
                    ...
                    <div class="btnshirt2">
                        <button class="buy-btn">Comprar</button>
                        <button onclick="clearContente()">Eliminar contenido</button>
                    </div>
                </div>
            </section>

                        <section class="cardshirt3" id="contentToDelete">
                ...
                <div class="product-infoshirt3">
                    ...
                    <div class="btnshirt3">
                        <button class="buy-btn">Comprar</button>
                    <button onclick="clearContentee()">Eliminar contenido</button>
                    </div>
                </div>
            </section>
